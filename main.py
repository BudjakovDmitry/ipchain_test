...
После этого можем работать с очередью входящих запросов, как только запрос выходит из очереди, забываем про него.
...
# Если это возможно, я бы поменял формат лога, чтобы обойтись без регулярных выражений.
